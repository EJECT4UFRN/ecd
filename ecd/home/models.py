...
class Course(models.Model):
    ...
    class Meta: 
        ...
        verbose_name_plural = '#01: Informações do Curso'
        ordering = ['title']
...
class Professor(models.Model):
    ...
    class Meta: 
        ...
        verbose_name_plural = '#02: Docentes'
        ordering = ['name']
...
class Discipline(models.Model):
    ...
    description = RichTextField('Descrição da Disciplina', null=True, blank=True)
    prepopulated_fields = {'slug':['name']}
    ...
    class Meta: 
        ...
        verbose_name_plural = '#03: Informações da Disciplina'
        ordering = ['title']
...
class Template(models.Model):
    ...
    class Meta: 
        ...
        verbose_name_plural = '#04: Templates'
        ordering = ['title']
...
class Infos(models.Model):
    ...
    class Meta: 
        ...
        verbose_name_plural = '#06: Descrição da Disciplina'
        ordering = ['title']
...
class Reference(models.Model):
    ...
    class Meta: 
        ...
        verbose_name_plural = '#07: Referências'
        ordering = ['title']
